...
class Detector(torch.nn.Module):
    ...
    def __init__(
        ...
        self.up1 = self.UpBlock(32, 16) # Output: (B, 16, 48, 64)
        self.up2 = self.UpBlock(16, 16) # Output: (B, 16, 96, 128)
    ...
    def forward(self, x: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        # Upsample (decoder)
        up1 = self.up1(down2) + self.skip1(down1) # (B, 16, 48, 64)
        # print("Shape after up1:", up1.shape)
        up2 = self.up2(up1) # (B, 16, 96, 128)
        ...
        # Segmentation head
        segmentation_out = self.segmentation_head(up2) # (B, num_classes, 96, 128)
